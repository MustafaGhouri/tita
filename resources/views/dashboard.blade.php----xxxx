          ...
          <li class="activity-item">
            ...
            <div class="w-100">
              <div class="activity-text">
                <strong>{{ $e->employee->name ?? 'Employee' }}</strong> completed mystery evaluation
              </div>
              <div class="activity-meta">{{ optional($e->created_at)->diffForHumans() }}</div>
            </div>
            <a class="link" href="{{ route('mystery.show',$e) }}">View</a>
          </li>
        @empty
  ...
  <div class="card">
    ...
    <div class="qa">
      <a href="{{ route('employees.create') }}" class="qa-btn bg-purple">
        ...
        <!-- <svg viewBox="0 0 24 24"><path d="m10 17 5-5-5-5v10Z"/></svg> -->
      </a>

     <!--  <a href="{{ route('employees.index') }}" class="qa-btn bg-blue">
        <span class="left">
          <span class="qa-icon">
      ...
      <a href="{{ route('employees.index') }}" class="qa-btn bg-orange">
        <span class="left">
          <span class="qa-icon">
      ...
      <a href="{{ route('employees.index') }}" class="qa-btn bg-green">
        <span class="left">
          <span class="qa-icon">
