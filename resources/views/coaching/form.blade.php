...
@section('content')
    <style>
        ...
        .cf-textarea:focus {
            border-color: #c7b5e0;
            box-shadow: 0 0 0 3px rgba(82, 37, 131, .12)
        }
    ...
    <div class="cf-card cf-pad">
        <h2 class="cf-title">{{ $session->exists ? 'Editar sesión de entrenamiento' : 'Nueva sesión de entrenamiento' }}</h2>
        ...
        <form method="POST" enctype="multipart/form-data"
            ...
            <div class="cf-grid">
                <div>
                    ...
                    <input type="date" name="date" value="{{ old('date', optional($session->date)->format('Y-m-d')) }}"
                        class="cf-input" required>
                </div>
                <div>
                    <label class="cf-label">fecha de seguimiento</label>
                    <input type="date" name="follow_up_date"
                        value="{{ old('follow_up_date', optional($session->follow_up_date)->format('Y-m-d')) }}"
                        class="cf-input">
                </div>
            </div>

            <div class="mt-3">
                <label class="cf-label">Resumen</label>
            ...
            <div class="mt-3">
                <label class="cf-label">Recomendaciones</label>
            ...
            <div class="cf-actions">
                ...
                <a href="{{ route('coaching.index', $employee) }}" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
@endsection
